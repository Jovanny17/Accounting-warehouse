			...
			if($password!="") {
				...
				if($check) {
					...
					if($block_date!="") {
						...
						$params=$params.",status='Deactivated',block_date='$block_date'";
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control required">
											...
											<option value="Deactivated" <?php if($status=='Deactivated') { ?> selected="selected" <?php } ?>>Deactivated</option>
			...
			<div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="block_date" class="form-control required">
                      <option value=""></option>
						 ...
						 <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control"  value="" autocomplete="off" id="password" name="password">
