...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
        ...
        <div class="form-group"><a class="btn btn-primary" href="find_article.php"> <i class="fa fa-plus"></i> Find Article</a>
								&nbsp;&nbsp;&nbsp;
								 <a class="btn btn-primary" href="add_task.php"> <i class="fa fa-plus"></i> Add Task</a> </div>
      </div>
    </div>
    <br />
    <?php if($_SESSION['msg']!="") { ?>
