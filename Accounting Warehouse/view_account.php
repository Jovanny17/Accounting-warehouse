		...
		<input type="hidden" name="id" value="<?php echo $id; ?>" />
			...
			<div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="fname">Account Code</label>
				    <input disabled="" type="text" class="form-control required" value="<?php echo $acctCode; ?>" id="acctCode" name="acctCode" required>
			  ...
			  <div class="col-md-4">
                <div class="form-group">
				  ...
				  <input disabled="" type="text" class="form-control required" value="<?php echo $acctName; ?>" id="acctName" name="acctName" required>
			  ...
			  <div class="col-md-4">
                <div class="form-group">
                  <label for="fname">Account Category</label>
				   <select disabled="" name="acctCategory" id="acctCategory" class="form-control" required> 
            ...
            <div class="row">
              ...
              <div class="col-md-6"> 
				...
				<select disabled="" name="term" id="term"  class="form-control" required> 
			  ...
			  <div class="col-md-6"> 
				...
				<select disabled=""name="normalside" id="normalside" class="form-control" required> 
              ...
              <div class="col-md-6">
                <div class="form-group">
				  ...
				  <select disabled="" name="acctStatus" id="acctStatus" class="form-control" required> 
            ...
            <div class="box-footer">
              ...
              <a href="chart_accounts.php"><input type="button" class="btn btn-primary" name="cancel" value=" Go back " /></a>
