...
if(isset($_REQUEST['action']))  {
			...
			if($_REQUEST['action']=='block') {
					...
					$user_id=intval($_REQUEST['user_id']);
								...
								$deleted=$db->Update_Record("users"," status='block' where  user_id=".$user_id);
								...
								if($deleted) {
										...
										$_SESSION['msg']="Error while Blocking the User";
...
$userRecords=$db->selectMultiRecords("select * from users where password_date<NOW() order by first_name,last_name");
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1> <i class="fa fa-users"></i> Expired Accounts</h1>
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 text-right">
        ...
        <div class="form-group"> <a class="btn btn-primary" href="add_user.php?group_id=2"> <i class="fa fa-plus"></i> Add User</a> </div>
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"> <a class="btn btn-sm btn-info" href="edit_user.php?user_id=<?php echo $record['user_id']; ?>" title="Edit"> <i class="fa fa-pencil"></i> </a></td>
